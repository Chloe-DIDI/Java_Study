...
○ StringBuffer 클래스는 문자열을 처리하는 클래스로
   ...
   개게를 생성하는 시점에서 미리 그 크기나 값을 지정하거나
   ...
   StringBuffer 보다 빠르면 동시성(동기화) 문제가 없다면
...
public class Test134
{
	...
	{	
		...
		*/
		...
		//	  『"한국"』이라는 문자열 추가
		sb3.insert(0, "한국");		//0번째 앞에 "한국"을 넣겟다
		...
		// 테스트 ② /*
		//sb3.insert(12, "사랑");		//12번째 뒤에 "사랑"을 넣겟다
