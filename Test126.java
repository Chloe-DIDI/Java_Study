...
○ Wrapper 클래스
	...
	2. 기본 자료형인 
	   byte, short, int,	long, float, double, char,		boolean 형에 대응하는 //프리미티브 자료형
	   Byte, Short, Intger,	Long, Float, Double, Character,	Boolean 의	//래퍼클래스 이름
...
○ 오토 박싱(Auto-Boxing)과 오토 언박싱(Auto-Unboxing)
	...
	이 경우 발생하는 문제 해결을위해 자바에서는 Wrapper 클래스를 제공하게 되었다.
	하지만, JDK 1.5 부터 레퍼런스 형과 기본 자료형이 
	다음과 같이 형 변환이 간으하게 되었다.
