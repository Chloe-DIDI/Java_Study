...
// 현재의 년, 월, 일, 요일을 Calender 객체를 활용하여 출력
...
public class Test138
{
	...
	{	
		...
		int m = rightNow.get(Calendar.MONTH) + 1;	//-- 인덱스 구조로 하기때문에 달력날짜
		System.out.println(m);						// 『+1』 해야됨~!!!!!!!!!
		//--==>> 8
		...
		rightNow2.set(2021, 11, 24);	//2021-12-24일 입력된 것 (월은 배열이라 -1)
		...
		// 달력의 날짜 세팅 → 각자의 생년월일
		rightNow2.set(1998, 1, 2);	// 1998년 2월 2일
