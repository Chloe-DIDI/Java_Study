...
public class Test096
{
	...
	//    동일한 클래스으; 메소드에서는 바로 접근하는 것이 가능하지만
	//    클래스 메소드에서는 접근할 수 없다.
	
	int b =20;					//--non-static 변수(인스턴스 변수) instance 변수
	
	void write()					//-non-static(인스턴스 메소드) instance 메소드
	{
	...
	public static void main(String[] args)
	{
		...
		//System.put.println("main() → 인스턴스 변수 b : " + b);
		//--==>> 에러 발생(컴파일 에러)
		//System.put.println("main() → 인스턴스 변수 b : " + Test096.b);
		//--==>> 에러 발생(컴파일 에러)
		...
		//--==>> 에러 발생(컴파일 에러)
		// why? 인스턴스를 통해서 접근해야되기때문에 인스턴스를 표시해야줘야댐
		
		System.out.println("main() → 인스턴스 변수 b : " + ob.b);
		//--===>> main() → 인스턴스 변수 b : 20

		//생성된 인스턴스를 통한 인스턴스 메소드 접급(호출)
		//--==>> 클래스 변수 a: 10
		//		 인스턴스 변수 b : 20
